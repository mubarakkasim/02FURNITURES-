...
<html lang="en">
	<head>
	    ...
	    <title>02Furnitures | Homepage</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	   	...
	   	<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/Sliders.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/sliders1.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
   ...
   <div class="full-width-slider">
		 ...
		 <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/sliders4.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->


		 <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/sliders3.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over NGN. 600.00</h6>	
				</div>
			</div><!-- .col -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<!-- ============================================== SCROLL TABS ============================================== -->
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp" style="background-color:#f8f8f8";>
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products &#128285;&#128526;&#127757;</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">New</a></li>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					NGN.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">NGN.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
...
?>
	...
	<?php } ?>
         ...
         <!-- ============================================== TABS ============================================== -->
			<div class="sections prod-slider-small outer-top-small" style="background-color:#f8f8f8";>
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">BRAND NEW FURNITURES &#127873; &#128076;</h3>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp" style="background-color:#f8f8f8";>
		<h3 class="section-title">NEW Fashion FURNITURES &#128525; &#128151;</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													NGN.<?php echo htmlentities($row['productPrice']);?>
												</span>
